          ...
          Container(
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [userInfoWidget(), const SizedBox(height: 50), proceedBtn()],
              ),
            ),
          ),
        ],
      ...
      builder: (context, userProfileProvider, _) {
        return userProfileProvider.profileState == ProfileState.loading
            ...
            : gradientBtnWidget(
                ...
                //           userProfileProvider.registerAccountApi(context: context, params: widget.loginParams ?? {}).then(
                //             (value) {
                //               if (value == "1") {
                //                 ToggleComponentsWidget(true);
                //               }
    ...
    return Form(
      ...
      child: Column(
        children: [
          ...
          SizedBox(height: Constant.size15),
          if(widget.from == "mobile_register")
          mobileNoWidget(),
          ...
          (widget.from != "header") ? SizedBox(height: Constant.size5) : const SizedBox.shrink(),
          (widget.from != "header")
              ? editBoxWidget(
                  context,
